...
{{Form::open(array('action'=>array('App\http\Controllers\PersonaController@update', $persona->id),
    'method'=>'patch'))}}
    <div class="row">
...
<div class="col-lg-6 col-md-9 col-sm-6 col-xs-12">
    ...
    <div class="col-lg-6 col-md-9 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            class="form-control"value="{{$persona->email}}">
        </div>
    </div>
    <div class="col-lg-6 col-md-9 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            class="form-control"value="{{$persona->telefono}}">
        </div>
    </div>
